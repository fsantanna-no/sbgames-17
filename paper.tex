...
The \code{await} allows for nested control-flow structures to suspend execution
while retaining all enclosing state alive.
...
%
\CEU overcomes the need of behavioral patterns with support for structured
control-flow mechanisms and event-based communication via broadcast.
%
