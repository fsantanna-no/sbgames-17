...
We present a case study of rewriting the game logic of Pingus from C++ to \CEU
with the contributions that follow:
%
\begin{itemize}
\item Identification of five recurrent control-flow patterns in the game logic
      that likely apply to other games.
\item Idiomatic solutions in \CEU for six selected behaviors in the game logic.
...
codebase: 18.173 from 39.362 LoCs (46\%) spread in 272 files.
%
...
%
Therefore, we rewrote 9.186 LoCs spread in 126 files%
\footnote{Game logic codebase: \url{https://github.com/an000/p/tree/master/cpp/}}.
%
...
statements, resulting in 70 implementation files with 4.135 dense LoCs
originally written in C++%
\footnote{``Effective'' C++ codebase: \url{https://github.com/an000/p/tree/master/all/}}.
We did the same with the implementation in \CEU, resulting in 3.697 dense LoCs%
\footnote{``Effective'' \CEU codebase: \url{https://github.com/an000/p/tree/master/all/}}.
%
...
\footnote{Double click animation: \url{https://github.com/an000/p/blob/master/README.md#1} }
...
\footnote{Bomber action animation: \url{https://github.com/an000/p/blob/master/README.md#2} }
%
...
follows%
\footnote{State machine animation: \url{https://github.com/an000/p/blob/master/README.md#3} }:
%
\begin{enumerate}
...
story screens%
\footnote{Story screen animation: \url{https://github.com/an000/p/blob/master/README.md#4} }.
...
\footnote{Death of pingus animation: \url{https://github.com/an000/p/blob/master/README.md#5} }.
%
...
boundaries%
\footnote{Mouse grab animation: \url{https://github.com/an000/p/blob/master/README.md#6} }.
