...
%
\begin{itemize}
\item Identification of five recurrent control-flow patterns that likely apply
      to other games.
\item Idiomatic code in \CEU for six selected behaviors in the game logic.
\item An in-depth qualitative analysis of the implementations in \CEU in
      comparison to C++.
\end{itemize}

TODO: falar mais sobre as 3 contribuicoes:
- control-flow patterns
    - o que eh isso
        - definir controle
    - como eh diferente de GoF
        - behavioral patterns
- ideia geral das solucoes
    - eliminar estados explicitos com estruturas de controle apropriadas
- o que eh analise qualitativa
    - como medimos
