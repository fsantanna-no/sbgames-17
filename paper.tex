...
\footnote{Game logic codebase: \url{https://github.com/sbgames-anon/paper-2017/tree/master/cpp/}}.
%
...
\footnote{``Effective'' C++ codebase: \url{https://github.com/sbgames-anon/paper-2017/tree/master/all/}}.
We did the same with the implementation in \CEU, resulting in 3.697 dense LoCs%
\footnote{``Effective'' \CEU codebase: \url{https://github.com/sbgames-anon/paper-2017/tree/master/all/}}.
%
...
boundaries%
\footnote{Mouse grab animation: \url{https://github.com/sbgames-anon/paper-2017/blob/master/README.md#6} }.
